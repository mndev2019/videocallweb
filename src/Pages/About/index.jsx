                            ...
                            <div className="content">
                                <div className="row">
                                    ...
                                    <div className="col-12">
                                        ...
                                        <p className="bottomborder pb-4 ">At JiveCam, we are dedicated to creating a platform that values inclusivity, creativity, and the joy of human connection. Join us today and be part of a global movement to <strong>Connect, Laugh, Repeat!</strong></p>
                                        <h4 className="main-title2">Let’s Jive!</h4>
                                        <p className="bottomborder pb-4">Download the app now and start your journey with JiveCam — where every interaction brings a smile!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
